          ...
          <section style={styles.resultCard}>
            ...
            <div style={styles.resultGrid}>
              ...
              <div style={styles.resultPanelSmall}>
                ...
                <div style={styles.priorityPill}>
                  {result.prioridad_comercial}
                </div>
              </div>
              ...
              <div style={styles.resultPanelLarge}>
                ...
                <div style={styles.resultText}>
                  {result.justificacion_del_score}
                </div>
              </div>
              ...
              <div style={styles.resultPanelLarge}>
                <div style={styles.resultLabel}>
                  URLs recomendadas para investigar
                </div>
                <ul style={styles.list}>
                  {result.urls_recomendadas_para_investigar.map(
                    (item, index) => (
                      <li key={index} style={styles.listItem}>
                        {looksLikeUrl(item) ? (
                          <a
...
const styles = {
  page: {
    minHeight: "100vh",
    background:
      "linear-gradient(180deg, #060608 0%, #0b0b10 55%, #101018 100%)",
    color: "#fff",
  ...
  hero: {
    ...
    borderRadius: "36px",
    background:
      "linear-gradient(135deg, rgba(20,20,24,0.82), rgba(10,10,14,0.72))",
  ...
  orbInner: {
    ...
    borderRadius: "34px",
    background:
      "radial-gradient(circle at center, rgba(255,122,24,0.22), rgba(10,10,12,0.98) 72%)",
  ...
  formCard: {
    ...
    borderRadius: "32px",
    background:
      "linear-gradient(180deg, rgba(18,18,22,0.88), rgba(10,10,12,0.80))",
    border: "1px solid rgba(255,255,255,0.08)",
  ...
  fitPanel: {
    ...
    borderRadius: "24px",
    background:
      "linear-gradient(135deg, rgba(255,122,24,0.18), rgba(255,91,31,0.08))",
    border: "1px solid rgba(255,122,24,0.22)",
  },
  fitLabel: {
    fontSize: "13px",
